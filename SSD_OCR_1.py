...
from util.ocr_detect import CaffeDetection
...
class SSD_OCR():
	...
	def __init__(self, model_def, model_weights, labelmap_file, gpu_id=0, image_resize=300, image_size=800, formule_pad=200):
		self.model_weights = model_weights
		self.image_size = image_size
		self.formule_pad = formule_pad
		self.model = CaffeDetection(gpu_id, model_def, model_weights, image_resize, labelmap_file)
	...
	def test_ocr(self, trace_seq):
		...
		cv2.waitKey(1000)
		result_box_all, result_sym_top5, result_conf_top5 = ocr_detect.main(det_img_args, self.model)
...
if __name__ == '__main__':
	...
	labelmap_file = "model/labelmap_voc_sym.prototxt"
	...
	model_ssd = SSD_OCR(model_def, model_weights, labelmap_file)
	result_box_all, result_sym_top5, result_conf_top5 = model_ssd.test_ocr(pt_seq)
